...
def funcion_teorica_log(n, logA, μ):
    """Función teórica en escala logarítmica: log(A) - μ * n"""
    return logA - μ * n

def funcion_teorica_normal(n, A, μ):
    """Función teórica en escala normal: A * exp(-μ * n)"""
    return A * np.exp(-μ * n)
...
# Añado etiquetas y leyenda (ubicada en la esquina superior derecha)
